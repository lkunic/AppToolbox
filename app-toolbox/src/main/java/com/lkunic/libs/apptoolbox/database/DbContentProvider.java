...
public abstract class DbContentProvider extends ContentProvider
{
	...
	public boolean onCreate()
	{
		...
		dbHelper = getDatabaseHelper(mDatabaseItemTypes);
	...
	public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder)
	{
		...
		builder.setTables(mDatabaseItemTypes[uriIndex].getDatabaseTableName());
	...
	public Uri insert(Uri uri, ContentValues values)
	{
		...
		// Set the table based on the uri type
		String tableName = mDatabaseItemTypes[uriIndex].getDatabaseTableName();
	...
	protected abstract DatabaseHelper getDatabaseHelper(IQueryable[] databaseItemTypes);
